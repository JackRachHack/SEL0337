...
# # from smbus2 import SMBus  # SMBus for I2C communication (comentado)

# # I2C address of the ESP32 (não será utilizado)
...
#         """
#         # self.bus = SMBus(1)  # Comentado para desabilitar I2C
#         self.create_widgets(root)  # Create the GUI components
#         self.listen_for_updates()  # Start listening for updates (não usaremos I2C, então vamos modificar)
...
#         # Send the updated states to the ESP32 (comentado, já que não usamos I2C)
#         # self.send_states()

#     # Comentado para não usar I2C
...
#         """
#         Print the current states of all buttons every 4 seconds.
#         """
#         # Print the current states of all buttons (no I2C updates)
#         print(f"Button States: {['ON' if state else 'OFF' for state in states]}")
        
#         # Schedule the next update after 4000 milliseconds (4 seconds)
#         root.after(4000, self.listen_for_updates)
